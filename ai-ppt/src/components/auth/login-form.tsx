  ...
  return (
    <div className="space-y-4">
      <div className="space-y-3">
        <Button
          variant="outline"
          className="h-auto w-full rounded-2xl border-border/70 px-5 py-4 transition-all duration-200 hover:-translate-y-0.5 hover:border-primary/40 hover:shadow-md hover:shadow-primary/10"
      ...
      <p className="text-center text-xs text-muted-foreground">
        Secure OAuth · No passwords required
      </p>
    </div>
  )
}
